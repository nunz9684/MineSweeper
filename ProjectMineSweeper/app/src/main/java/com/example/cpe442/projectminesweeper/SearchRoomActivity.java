...
public class SearchRoomActivity extends AppCompatActivity {
    ...
    private class GetDataBinding extends AsyncTask<String, Void, Integer> {
        ...
        protected void onPostExecute(Integer result) {
            ...
            if (result == 1) {
                adapter = new MyRecyclerViewAdapter(SearchRoomActivity.this, feedsList);
                ...
                adapter.setOnItemClickListener(new OnItemClickListener() {
                    ...
                    public void onItemClick(JSONData item) {
                        Toast.makeText(SearchRoomActivity.this, item.getTitle(), Toast.LENGTH_LONG).show();

                    }
                });

            } else {
                Toast.makeText(SearchRoomActivity.this, "Failed to fetch JSON data!", Toast.LENGTH_SHORT).show();
            }
        }
    }
